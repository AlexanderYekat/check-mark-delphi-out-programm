...
// =====================================================
// ФУНКЦИЯ: Отправить команду в Delphi программу
// =====================================================
// Параметры:
//   ИмяКоманды - Строка - имя команды:
//     "process" - начать обработку чека
//     "closing" - чек закрывается (сохранить результаты)
//     "closed"  - чек закрыт (очистить данные)
//     "cancel"  - отменить чек
// Возвращаемое значение:
//   Булево - Истина, если команда успешно отправлена
//
Функция ОтправитьКоманду(ИмяКоманды) Экспорт
    ...
    Попытка
        ...
        Сообщить("✓ Команда отправлена в Delphi: " + ИмяКоманды);
        Возврат Истина;
